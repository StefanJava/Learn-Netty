...
import com.stefan.netty.nio.ChannelAdapter;
import com.stefan.netty.nio.ChannelHandler;
...
/**
 * @description: nio server 处理器
 * @author: stefanyang
 * @date: 2023/2/14 09:43
 * @version: 1.0
 */
public class NioServerHandler extends ChannelAdapter {
    ...
    public void channelActive(ChannelHandler channelHandler) {
        try {
            ...
            channelHandler.writeAndFlush("hi! 今天guangdong很冷 NioServer to msg for you \r\n");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
